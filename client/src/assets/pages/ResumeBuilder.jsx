...
// ✅ Uncomment when you actually have data
...
const ResumeBuilder = () => {
  ...
  const saveResume = async() => {
    try {
      ...
      typeof resumeData.personal_info.image !== 'string' && formData.append("image", resumeData.personal_info.image)
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-4 relative overflow-hidden">
              {/* Progress Bar */}
                ...
                <div className="flex items-center gap-2">
                  {activeSectionIndex !== 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100"
                    >
              ...
              <div className="space-y-6">
                ...
                { activeSection.id === "education" && (
                  <EducationalForm data={resumeData.education}
